...
import { getPracticeQuestions } from "../../actions/take_practice_quiz";
...
class ConnectedPracticeQuiz extends React.Component {
  ...
  render() {
    ...
    loading = (
      <div>
        {isLoading ? (
          ...
          <div
            className={practiceQuizStyles.loadingScreen}
            style={{ display: "none" }}
          ></div>
        )}
      </div>
    ...
    if (this.state.timed === "yes") {
      durationFields = (
        <>
          <Form.Label className={practiceQuizStyles.labels}>
            Duration
          </Form.Label>
    ...
    return (
      <>
        ...
        <Container fluid className={practiceQuizStyles.page_header}>
          PRACTICE QUIZ
        </Container>
        <Container className={practiceQuizStyles.container}>
          <Form id="create-quiz-form" className={practiceQuizStyles.form}>
            ...
            <Card className={practiceQuizStyles.card}>
              <h2 className={practiceQuizStyles.instructions}>
                Enter the number of questions to be generated
              </h2>
              <Form.Group
                controlId="multiplechoicequestions"
                style={{ margin: "0" }}
              >
                <Form.Label className={practiceQuizStyles.labels}>
              ...
              <Form.Group
                controlId="fillintheblankquestions"
                style={{ margin: "0" }}
              >
                <Form.Label className={practiceQuizStyles.labels}>
              ...
              <Form.Group
                controlId="trueorfalsequestions"
                style={{ margin: "0" }}
              >
                <Form.Label className={practiceQuizStyles.labels}>
            ...
            <Card className={practiceQuizStyles.card}>
              ...
              <p className={practiceQuizStyles.fileTypes}>
                Accepted file types: {fileTypesToDisplay.join(", ")}
              </p>
              <FileUploader
