...
class Alert extends React.Component {
  ...
  render() {
    ...
    if(this.props.type === "success"){
      alert = (<Container  className={alertStyles.alertSuccess}> 
        <p><span>Success:</span> {message}</p>
        <p style={{float: "right", cursor: "pointer"}}><span onClick={this.props.delete}>X</span></p>
      </Container>);
    }

    if(this.props.type === "fail"){
      alert = (<Container  className={alertStyles.alertFail}> 
